...
Unless you want to edit the dictionary in `./src/dictionary.ts` or it is just a small edit e.g. a type fix, please claim an issue first or open a new issue and claim it before working on the code. This is to avoid duplicate efforts.
